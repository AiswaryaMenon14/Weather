...
function App() {
  ...
  const API_key = "cab755a83b6e6ed5f85100b8b8c59d52";
  ...
  const handleSearch = async (e) => {
    ...
    if (city.trim() === "") return setError("Please enter a City or Country");
        ...
        <div className="bg-transparent backdrop-filter backdrop-blur-md rounded-xl shadow-2xl p-8 max-w-md text-white w-full border border-white/30 relative z-10">
          ...
          {!weather ? (
            <form onSubmit={handleSearch} className="flex flex-col relative">
              ...
              <button
                type="submit"
                className="bg-purple-700 hover:to-blue-600 text-white font-semibold py-2 px-4 rounded transition-colors"
              >
                Get Weather
              </button>
            </form>
            ...
            <div className="mt-6 text-center transition-opacity duration-500">
              <button
                ...
                className="mb-4 bg-purple-600 text-white font-semibold py-1 px-3 rounded transition-colors"
              >
                New Search
              </button>
              ...
              <img
                ...
                alt={weather.weather[0].descirption}
              ...
              <div className="flex flex-wrap justify-around mt-6">
                {[
                  ...
                  <div className="flex flex-col items-center m-2" key={label}>
                    <Icon />
